...
output$basesmod1 <- DT::renderDataTable({
  ...
  CCC_TAC_BB_CREAM_M6913O002 <- c(EMH =8,ZnO = 4,FPS_INVIVO=32.9,Costo_EMH=3299,Costo_ZnO=3554,Costo_total=6853)
  MOD1bases <- data.frame(rbind(ESK_PRO_INSTAN_25,ESK_RADIANCE_25,
                                LB_BASE_GOTERO_25, ESK_HIDRONUTRITIVA_25,
                                LB_EFFET_PAR_MINIMIZER_20,LB_CUSHION_20,
                                CCC_TAC_BB_CREAM_M6913O002))
...
output$basesmod2 <- DT::renderDataTable({
  ...
  ESK_COLORFIX_ULTRA_RESIST_FPS30 <- c(EMH =6.5,ZnO = 3.6,FPS_INVIVO=33.2,Costo_EMH=2681,Costo_ZnO=3198,Costo_total=5879)
  ...
  MOD2bases <- data.frame(rbind(Cy_go_base_ligera_20,CY_STUDIO_LOOK_20,ES_PRO_MOLDEABLE_FULL_COV_25,
                                ...
                                ESK_BB_CREAM_30,LBEL_HYDRO_ABS_FPS_25,
                                LB_CC_CREAM_MATE_FPS_30, ESK_PRO_NATURAL_MATIFIC_25,
                                ESK_COLORFIX_ULTRA_RESIST_FPS30))
